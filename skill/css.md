...
### Two-Column Comparison (S4HANA Style)

Perfect for "vs" slides (ROP vs MRP, Before vs After):

```html
<body class="col">
  <div class="title-section fit">
    <h1>ROP vs MRP Comparison</h1>
    <p class="governing-message">Choose ROP for bottleneck materials with high supply risk, MRP for leverage materials with predictable demand.</p>
  </div>
  ...
  <div class="fill-height row gap items-fill-width">
    <div>
      ...
      <h3>Best For</h3>
      <p>Bottleneck materials - high supply risk</p>

      <h3>Key Features</h3>
      <ul>
        <li>Independent demand</li>
        <li>Automatic reordering</li>
        <li>Safety stock focus</li>
      </ul>
    </div>
    ...
    <div>
      ...
      <h3>Best For</h3>
      <p>Leverage materials - low supply risk</p>
...
**For 2-column layouts (comparisons, vs slides):**
- ✅ Use `.row .gap .items-fill-width` for equal-width columns
- ✅ Ensure both columns have similar content length for visual balance
- ✅ Use consistent heading levels in both columns (both h2, both h3, etc.)
- ✅ Align bullet points: Same number of items or justify content to top
- ✅ Test with actual content - placeholder text may not reveal alignment issues

**For multi-row layouts:**
- ✅ Use `.col` on body and section containers
- ✅ Apply `.fit` to header/footer to prevent expansion
- ✅ Apply `.fill-height` to main content area
- ✅ Use `.gap` classes consistently between sections

**Common alignment mistakes:**
- ❌ Mixing `.row` and inline flex styles
- ❌ Forgetting `.items-fill-width` for equal columns
- ❌ Using different heading levels in comparison columns
