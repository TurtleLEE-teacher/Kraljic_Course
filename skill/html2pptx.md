...
⚠️ **CRITICAL: HTML `<table>` tags are NOT supported**

- HTML `<table>`, `<tr>`, `<td>`, `<th>` elements **will not render** in PowerPoint
- If you need tables, use **PptxGenJS `slide.addTable()`** method instead
- See "Adding Tables" section below for complete guide
...
⚠️ **REMINDER**: HTML `<table>` tags are NOT supported. Always use PptxGenJS `slide.addTable()`.
...
#### 2×2 Matrix Table (e.g., Kraljic Matrix)

Perfect for strategy frameworks and comparison matrices:

```javascript
const { slide, placeholders } = await html2pptx("slide.html", pptx);

// Create 2×2 matrix with header row/column
const matrixData = [
  // Header row
  [
    { text: "", options: { fill: { color: "F5F5F5" } } },
    { text: "Low Risk", options: { bold: true, fill: { color: "F5F5F5" }, align: "center" } },
    { text: "High Risk", options: { bold: true, fill: { color: "F5F5F5" }, align: "center" } }
  ],
  // Row 1
  [
    { text: "High Impact", options: { bold: true, fill: { color: "F5F5F5" }, valign: "middle" } },
    { text: "Leverage Materials\n• Competitive bidding\n• Price negotiation", options: { align: "left", valign: "top" } },
    { text: "Strategic Materials\n• Long-term partnership\n• Risk management", options: { align: "left", valign: "top" } }
  ],
  // Row 2
  [
    { text: "Low Impact", options: { bold: true, fill: { color: "F5F5F5" }, valign: "middle" } },
    { text: "Routine Materials\n• Process automation\n• E-procurement", options: { align: "left", valign: "top" } },
    { text: "Bottleneck Materials\n• Alternative sourcing\n• Safety stock", options: { align: "left", valign: "top" } }
  ]
];
...
slide.addTable(matrixData, {
  ...
  colW: [1.5, 3.75, 3.75],  // Column widths
  rowH: [0.6, 1.45, 1.45],  // Row heights
  fontSize: 12,
  color: "333333"
});
```
